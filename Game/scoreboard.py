...
class Scoreboard:
    ...
    def __init__(self, gp_game):
        """initialize scorekeeping atribbutes"""
        self.gp_game = gp_game
        self.screen =gp_game.screen
        self.screen_rect =self.screen.get_rect()
        self.settings =gp_game.settings
        self.stats =gp_game.stats
    ...
    def prep_players(self):
        ...
        for player_number in range(self.stats.players_left):
            player= Player(self.gp_game)
            player.rect.x =250 +player_number *player.rect.width
            player.rect.y =635
